...
```{r}
# project_data_path_chr <- params$r_data_dir_chr %>% stringr::str_replace("R_Format","Project")
...
# input_ls <- params$input_ls_chr %>% readRDS()
# sim_data_r4 <- params$sim_data_r4_chr %>% readRDS()
# sim_results_ls <- params$sim_results_ls_chr %>% readRDS()
...
```{r, include=F}
# project_data_path_chr <-params$r_data_dir_chr %>% stringr::str_replace("R_Format","Project")
# input_ls <- readRDS(paste0(project_data_path_chr,"/input_ls_3.rds"))
# sim_data_r4 <- readRDS(paste0(project_data_path_chr,"/sim_data_r4_3.rds"))
# sim_results_ls <- readRDS(paste0(project_data_path_chr,"/sim_results_ls_3.rds"))
#input_ls$pa_r4@lookup_tb@sp_abbreviations_lup <- springtides::aus_pa_r4@lookup_tb@sp_abbreviations_lup
```
